...
if (INCLUDE_REV) {
  ...
  model_loop_rev <- rol_hor_model_loop(doelreeks_rev, MODEL_VECTOR, 
                                       STARTTEST, N_TEST, H, 
  ...
  # Als een extra check dat de error modellen goed gefilterd zijn, wordt 
  # gekeken of de dimensies van de data frames overeen komen.
